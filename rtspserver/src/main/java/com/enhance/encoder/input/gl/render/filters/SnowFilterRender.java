package com.enhance.encoder.input.gl.render.filters;
...
import com.enhance.encoder.utils.gl.ImageStreamObject;
...
public class SnowFilterRender extends BaseFilterRender {
  ...
  protected void initGlFilter(Context context) {
    String vertexShader = GlUtil.getStringFromAssets(context, "glsl/simple_vertex");
    String fragmentShader = GlUtil.getStringFromAssets(context, "glsl/snow_fragment");
...
//    Bitmap snowBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.snow_flakes);
    ...
    try {
      snowBitmap = BitmapFactory.decodeStream(context.getResources().getAssets().open("img/snow_flakes.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
