package com.enhance.encoder.input.gl.render.filters.object;
...
import com.enhance.encoder.input.gl.Sprite;
import com.enhance.encoder.input.gl.TextureLoader;
import com.enhance.encoder.utils.gl.GlUtil;
import com.enhance.encoder.utils.gl.StreamObjectBase;
import com.enhance.encoder.utils.gl.TranslateTo;
import com.enhance.encoder.input.gl.Sprite;
import com.enhance.encoder.input.gl.TextureLoader;
import com.enhance.encoder.input.gl.render.filters.BaseFilterRender;
import com.enhance.encoder.utils.gl.GlUtil;
import com.enhance.encoder.utils.gl.StreamObjectBase;
import com.enhance.encoder.utils.gl.TranslateTo;
...
abstract public class BaseObjectFilterRender extends BaseFilterRender {
  ...
  protected void initGlFilter(Context context) {
    String vertexShader = GlUtil.getStringFromAssets(context, "glsl/object_vertex");
    String fragmentShader = GlUtil.getStringFromAssets(context,"glsl/object_fragment");
