package com.enhance.encoder.input.gl.render;
...
import com.enhance.encoder.utils.gl.SizeCalculator;
...
public class SimpleCameraRender {
  ...
  public void initGl(Context context, int streamWidth, int streamHeight) {
    ...
    String fragmentShader = GlUtil.getStringFromAssets(context, "glsl/camera_fragment");
