...
import static com.enhance.encoder.input.video.CameraHelper.*;
  ...
  public void switchCamera() {
    try {
      ...
      if (cameraDevice == null || isFrontCamera) {
        cameraId = getCameraIdForFacing(cameraManager, CameraHelper.Facing.BACK);
      } else {
        cameraId = getCameraIdForFacing(cameraManager, CameraHelper.Facing.FRONT);
      }
